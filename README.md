...
| [Website Change Monitor](intermediate/03-website-change-monitor/README.md) | intermediate | Detect changes to configured web pages with a one-shot, cron-friendly CLI and responsible fetching. |
<!-- project-index:end -->
